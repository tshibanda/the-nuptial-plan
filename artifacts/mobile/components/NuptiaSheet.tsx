...
export function NuptiaSheet() {
  ...
  // Keep Nuptia close to the navigation bar so the reserved content zone
  // remains clear above the floating controls.
  const fabBottom = tabBarH + (Platform.OS === 'ios' ? insets.bottom : 0) + 4;
