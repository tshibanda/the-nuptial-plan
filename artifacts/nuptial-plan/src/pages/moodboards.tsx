...
const schema = z.object({
  ...
  sourceUrl: z.string().url('Ajoutez un lien Pinterest, Instagram ou Canva valide').or(z.literal('')),
  accent: z.string(),
});
...
export default function Moodboards() {
  ...
  const save = (data: FormData) => {
    ...
    if (!imageUrl) {
      form.setError('imageUrl', { message: 'Ajoutez une image ou un lien Pinterest, Instagram ou Canva' });
      return;
    }
